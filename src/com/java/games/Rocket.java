...
public class Rocket extends GameObject{
    ...
    public Rocket(double x, double y) {
        ...
        downFire = new RocketFire(new ArrayList<>(Arrays.asList(
                ShapeMatrix.FIRE_DOWN_1,
                ShapeMatrix.FIRE_DOWN_2,
                ShapeMatrix.FIRE_DOWN_3)));

        leftFire = new RocketFire(new ArrayList<>(Arrays.asList(
                ShapeMatrix.FIRE_SIDE_1,
                ShapeMatrix.FIRE_SIDE_2)));

        rightFire = new RocketFire(new ArrayList<>(Arrays.asList(
                ShapeMatrix.FIRE_SIDE_1,
                ShapeMatrix.FIRE_SIDE_2)));
    }
